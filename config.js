...
//  No avatars · No particles · Public Unsplash backgrounds
// ============================================================
...
module.exports = {
  ...
  scenes: [
    ...
    // Photo: kids doing robotics / electronics
    {
      duration:           4.0,
      transition:         'zoom-in',
      ...
      layers: [
        {
          type:    'image',
          src:     'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=1080&q=80',
    ...
    // Photo: circuit board / tech close-up
    {
      tts: {
      ...
      layers: [
        ...
        // Inline photo — students coding
        {
          type: 'image',
          src:  'https://images.unsplash.com/photo-1535223289827-42f1e9919769?w=600&q=80',
          x: 540, y: 1380, width: 860, height: 460,
          fit: 'cover', borderRadius: 32, opacity: 0.88,
        },
        {
    ...
    // Photo: calendar / planning desk
    {
      ...
      layers: [
        {
          type: 'image',
          src:  'https://images.unsplash.com/photo-1506784983877-45594efa4cbe?w=1080&q=80',
          x: 0, y: 0, width: 1080, height: 1920, fit: 'cover',
        },
        ...
        {
          type: 'image',
          src:  'https://images.unsplash.com/photo-1455849318743-b2233052fcff?w=700&q=80',
          x: 540, y: 1360, width: 860, height: 400,
          fit: 'cover', borderRadius: 28, opacity: 0.75,
        },
        {
          type: 'text', text: "Don't miss your chance to\nchange your future.",
          x: 540, y: 1660, fontSize: 46,
          fontFamily: 'Arial, sans-serif',
    ...
    // Photo: laptop + code editor
    {
      ...
      layers: [
        {
          type: 'image',
          src:  'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=1080&q=80',
          x: 0, y: 0, width: 1080, height: 1920, fit: 'cover',
        },
    ...
    // Photo: students collaborating / learning
    {
      tts: {
    ...
    // ── SCENE 6 — CTA / CONTACT ───────────────────────────────────────────
    // Photo: futuristic tech / bright hope
    {
      tts: {
      ...
      layers: [
        {
          type: 'image',
          src:  'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=1080&q=80',
          x: 0, y: 0, width: 1080, height: 1920, fit: 'cover',
        },
        ...
        // Student photo strip
        {
          ...
          x: 540, y: 1060, width: 860, height: 400,
          fit: 'cover', borderRadius: 28, opacity: 0.82,
        },
        // Contact card
        {
          type: 'shape', shape: 'rect',
